package com.azish.designpattern.structural.flyweight;

import java.util.Random;

// Driver class
public class CounterStrikeMain
{
    ...
    public static void main(String args[])
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            System.out.println("identityHashCode = " + System.identityHashCode(p));
        }
    }
    ...
    public static String getRandWeapon()
    {
        ...
        int randInt = r.nextInt(weapons.length-2);
